...
var oldArray1 = [0, 1, 2, 3, 4, 5, 6, 7];
var oldArray2 = [1, 2, 3, 4, 5, 6, 7, 8];
var oldArray3 = [2, 3, 4, 5, 6, 7, 8, 9];
var oldArray4 = [3, 4, 5, 6, 7, 8, 9, 0];
var oldArray5 = [4, 5, 6, 7, 8, 9, 0, 1];
var oldArray6 = [5, 6, 7, 8, 9, 0, 1, 2];

var masterArray = [oldArray1, oldArray2, oldArray3, oldArray4, oldArray5, oldArray6];
var newArray = []

for(var i = 0; i < masterArray.length; i++){
  for(var j = 0; j < masterArray[i].length; j++){
   newArray.push(masterArray[i][j]);
  }
}
